...
int main(int argc, char** argv)
{
    ...
    try {
        ...
        // Since we are only using one thread here this can cause the io context to block
        ...
        std::cerr << "starting io context" << std::endl;

        io.run();

        std::cerr << "stopped io context" << std::endl;
    }
    catch (const std::exception& e) {
